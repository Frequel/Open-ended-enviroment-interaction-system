...
public class CustomTransformComponent : Editor
{
    ...
    private void StandardTransformInspector()
    {
        ...
        //            //var pp = (Camera.main.farClipPlane * (_transform.localPosition.y + 11.52f) / (11.52f * 2)) + Camera.main.transform.position.z; //inside the camera frustrum -> range value [zCam,farClippingPlane]
        //            //localPosition = new Vector3(localPosition.x, localPosition.y, pp + 1);
        //        }
        //didPositionChange = true;
    ...
    private void AlignmentInspector()
    {
        ...
        alignmentAxis = (AxisFlag)EditorGUILayout.EnumFlagsField("Axis", alignmentAxis, layoutMaxWidth);
    ...
    private void RandomRotatationInspector()
    {
        ...
        rotationAxisFlag = (AxisFlag)EditorGUILayout.EnumFlagsField("Rotation Axis", rotationAxisFlag, layoutMaxWidth);
    ...
    private void RandomScaleInspector()
    {
        ...
        scaleAxisFlag = (AxisFlag)EditorGUILayout.EnumFlagsField("Scale Axis", scaleAxisFlag, layoutMaxWidth);
